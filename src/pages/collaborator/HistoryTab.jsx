    ...
    <div class="card mb-3 cardActionItem">
      {histories.map((item) => (
        <div className="col-md-11 cardHistoItem">
          <div className="row">
            <div className="time">
              {item.createTimeDetail.short_VN}, ngày {item.createTimeDetail.dayStr} {" "}
            ...
            <div className="deltailMoney">
              ...
              <div className="moneyItem">
                <div className="col-md-6">Số người tham gia</div>
                <div className="col-md-6 numberMoney">
                  {item.numberParticipant}
                </div>
              </div>
              <div className="moneyItem">
                <div className="col-md-6">Tiền trung bình</div>
                <div className="col-md-6 numberMoney">
            ...
            {item.list_CFDM_Detail_VM_DTO.map((item, index) => (
              <div className="divide">
                ...
                <div className="col-lg-2">
                  ...
                  <div>
                    <FaLongArrowAltRight style={{width: "100%"}}/>
                  </div>
                </div>
